import type { HTTPMethods, RequestGenericInterface } from 'fastify'
import type { CustomRequestHandler, CustomRouteOptions } from '../types.js'
...
export default class HealthRouter implements CustomRouteOptions<HealthRequest> {
  ...
  handler: CustomRequestHandler<HealthRequest> =
